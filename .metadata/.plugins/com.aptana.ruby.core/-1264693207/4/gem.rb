module Gem
  ...
  ConfigMap = {}
  ConflictError = Gem::ConflictError
  ...
  LOADED_SPECS_MUTEX = #<Mutex:0x944dce4>
  ...
  RUBYGEMS_DIR = "/home/mycomputer/.rvm/rubies/ruby-2.0.0-p648/lib/ruby/site_ruby/2.0.0"
  ...
  def self.detect_gemdeps(arg0, arg1, *rest)
  end
  ...
  def self.use_gemdeps(arg0, arg1, *rest)
  end
